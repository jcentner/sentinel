...
**All MVP success criteria met.** 5 detectors, LLM judge, docs-drift detection, finding persistence, git churn hotspots, embedding-based semantic context, and GitHub issue creation. 370 tests, 100% precision/recall on ground truth, real-world validated. See the [roadmap](roadmap/) for details.
