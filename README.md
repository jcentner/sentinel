...
- **14 detectors** — lint (Python/JS/TS/Go/Rust), docs-drift, semantic docs-drift, test-code coherence, dependency audit, complexity, dead code, git hotspots, TODO scanner, stale env config, unused deps
